...
if(isset($_POST['submit']))
  {
    ...
    $email=$_POST['email'];
        ...
        $query=mysqli_query($con,"select ID from tblcust where  CustEmail='$email' and CustMobilenumber='$contactno' ");
...
<html>
<head>
<title>Toll Plaza Management System || Forgot Page</title>
