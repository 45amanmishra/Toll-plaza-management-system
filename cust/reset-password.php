...
if(isset($_POST['submit']))
  {
    ...
    $password=md5($_POST['newpassword']);
        ...
        $query=mysqli_query($con,"update tblcust set CustPassword='$password'  where  CustEmail='$email' && CustMobilenumber='$contactno' ");
   if($query)
   {
...
<html>
<head>
<title>Toll Plaza Management System || Reset Page</title>
