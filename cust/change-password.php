...
$query=mysqli_query($con,"select ID from tblcust where ID='$custid' and   StaffPassword='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update tblcust set StaffPassword='$newpassword' where ID='$custid'");
...
<html>
<head>
<title>Toll Plaza Management System || Change Password</title>
...
<div id="wrapper">
    ...
    echo $msg;
          ...
          <fieldset>
            <?php
$sid=$_SESSION['ttmscid'];
$ret=mysqli_query($con,"select * from tblcust where ID='$sid'");
$cnt=1;
